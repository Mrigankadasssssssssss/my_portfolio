...
const icons = [canva, ai, figma, chatgpt, github, youtube, chrome];
...
const socialMedia = [
  {
    ...
    icon: git,
    name: "GitHub",
    username: "Mrigankadasssssssssss ",
    link: "https://github.com/Mrigankadasssssssssss",
  },
 
  {
    ...
    icon: linkedin,
    name: "Linkedin",
    username: "Mriganka Das",
    link: "https://www.linkedin.com/in/mriganka-das-4ab813242/",
  },
];
