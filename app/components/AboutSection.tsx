...
import me from "../../public/mriganka.jpg";
    ...
    <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-10">
      <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-8">
        ...
        <p className="mt-4 text-muted-foreground lg:text-lg">
          I am Mriganka Das, a Computer Science Engineering student at NSEC,
          specializing in MERN Stack development with several completed
          projects. Enthusiastic about AI-ML and DevOps, I have a well-rounded
          skill set ready for further growth in computer science.
        </p>
